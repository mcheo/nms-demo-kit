...
# Create Infra workspace
curl --location -k --request POST 'https://127.0.0.1/api/acm/v1/infrastructure/workspaces' \
--header 'Accept: application/json' \
--header 'Content-Type: application/json' \
-u $login_credential \
--data-raw '{
    "name": "my_infra_workspace"
}'

sleep $sleep_counter

# Create Infra Env
curl --location -k --request POST 'https://127.0.0.1/api/acm/v1/infrastructure/workspaces/my_infra_workspace/environments' \
--header 'Accept: application/json' \
--header 'Content-Type: application/json' \
-u $login_credential \
--data-raw '{
...
curl --location -k --request POST 'https://127.0.0.1/api/acm/v1/services/workspaces' \
--header 'Accept: application/json' \
--header 'Content-Type: application/json' \
-u $login_credential \
--data-raw '{
...
--data-raw '{
   "name":"httpbin-api",
   "version":"1.0",
   "specRef":"httpbin-1-0-oas3",
   "proxyConfig":{
      "hostname":"api.gwcluster.com",
      "ingress":{
...
# # Update Proxy Policy
# curl --location -k --request PUT 'https://127.0.0.1/api/acm/v1/services/workspaces/my_proxy_workspace/proxies/httpbin-api' \
# --header 'Accept: application/json' \
# --header 'Content-Type: application/json' \
# -u $login_credential \
# --data-raw '{
